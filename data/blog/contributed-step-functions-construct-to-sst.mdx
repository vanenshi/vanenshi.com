---
title: Scaling the Inbox - How I Contributed the Step Functions Construct to SST
description: How I Contributed the Step Functions Construct to SST
publishedAt: 2026-05-11
image: /static/images/step-functions-construct.webp
...
3. **Software-Level Backoff:** Implement an exponential wait step within the flow so that retries didn't stack on top of each other at the API gateway level.
...
Seeing it work in production, I opened a [Feature Request](https://github.com/anomalyco/sst/issues/4660) and a [Pull Request](https://github.com/anomalyco/sst/pull/5691).
